...
main.innerText = " I am DOM Toretto, and this is my Bio"
  // Part 2
...
// favThings.removeChild("li:last:child")
...
e.remove()
  ...
  // Part 5
let races = document.querySelector("#past-races").getElementsByTagName("li");
races[3].remove()

  // Part 6
let pastR = document.createElement("li")
pastR.innerText = "New York"
document.querySelector("#past-races").appendChild(pastR)// add elements to anything that we select first

  // Part 7
let y = document.createElement("div")
y.setAttribute("class","blog-post")
y.innerHTML = "<h1> New York </h1> <p>After Dom and Cipher target Mr. Nobody's home base. </p>"
body.appendChild(y)
